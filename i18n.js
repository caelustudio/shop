...
(function () {
  var DICT = {
    ...
    '关于商店接入支付系统': ['关于商店接入支付系统', '關於商店接入支付系統', 'About bringing payments to the shop'],
    'Caelus Studio正在为周边商店接入支付系统，届时您可以通过以下支付方式支付': ['Caelus Studio正在为周边商店接入支付系统，届时您可以通过以下支付方式支付', 'Caelus Studio正在為周邊商店接入支付系統，屆時您可以通過以下支付方式支付', 'Caelus Studio is adding a payment system to the merch store. Once it goes live, you will be able to pay with the following methods'],
    '1.支付宝': ['1.支付宝', '1.支付寶', '1. Alipay'],
    '2.微信': ['2.微信', '2.微信', '2. WeChat'],
    '在接入支付系统期间，我们将会对商店所有页面进行维护更新，可能会持续一段时间，很抱歉给各位带来的不便': ['在接入支付系统期间，我们将会对商店所有页面进行维护更新，可能会持续一段时间，很抱歉给各位带来的不便', '在接入支付系統期間，我們將會對商店所有頁面進行維護更新，可能會持續一段時間，很抱歉給各位帶來的不便', 'While the payment system is being integrated, we will be carrying out maintenance and updates across every shop page. This may take a while — sorry for the inconvenience.'],
    '注：此为不肯定更新，可能会撤销此更新': ['注：此为不肯定更新，可能会撤销此更新', '註：此為不肯定更新，可能會撤銷此更新', 'Note: this update is not confirmed and may be reverted.'],
